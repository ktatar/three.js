...
class SynthPresets extends Object3D {
	...
	p19A_polyphonicSequenceBuffer(){

		this.preset = new Preset19A_PolyphonicSequenceBuffer( this );

	}

	p20_soundEffect(){

		this.preset = new Preset20_SoundEffect( this );
...
class Preset19A_PolyphonicSequenceBuffer{
...
class Preset20_SoundEffect{
	...
	constructor( synthPresets ){
		...
		// BUFFERS
			...
			this.audioBuffer.ramp( 0 , 1 , 0.99 , 0.995 , 10 , 0.2 ).multiply( 0 );
